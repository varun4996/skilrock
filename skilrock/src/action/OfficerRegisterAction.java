...
import varun.service.ORegistration;
public class OfficerRegisterAction {
	private String o_first,o_last,o_password,o_email,o_phone;
	public String execute(){
	    int i=ORegistration.saveOfficer(this);  
	    if(i>0){  
	    return "success";  
	    }  
	    return "error";  
